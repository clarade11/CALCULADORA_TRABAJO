...
public class Calcu {
	...
	public String acum = "";// VARIABLE QUE ACUMULA EL VALOR DIGITADO
	public double a; // VARIABLE QUE ALMACENA EL PRIMER VALOR DIGITADO
	...
	public Calcu() {
		...
		// 1. CREAMOS EL FRAME
		frame = new JFrame("Calculadora");// ESTE ES EL NOMBRE DE FRAME EL QUE SE UBICA EN LA PARTE DE ARRIBA DEL
											// FORMULARIO
		...
		Mostrar = new JTextField();// NO TIENE DIMENSION
		...
		//AÑADIMOS LOS BOTONES EL PANEL

		mp1.add(Mostrar);// AÑADE EL PANEL QUE TIENE LA CAJA DE TEXTO MP1
		mp.add(B_1);// AÑADIMOS LOS BOTONES EL PANEL MP EN ORDEN DE LA CALCULADORA
		mp.add(B_2);
		mp.add(B_3);
		mp.add(B_S);
		mp.add(B_4);
		...
		B_M.addActionListener(new ActionListener() {// BOTON QUE REALIZA LA OPERACION DE MULTIPLICAR
			public void actionPerformed(ActionEvent e) {
				acum = Mostrar.getText();
				a = (Double.parseDouble(acum));
				c = "*";
		...
		B_r.addActionListener(new ActionListener() {// BOTON QUE REALIZA LA OPERACION DE RESTAR
			public void actionPerformed(ActionEvent e) {
				acum = Mostrar.getText();
				a = (Double.parseDouble(acum));
				c = "-";
		...
		B_D.addActionListener(new ActionListener() {// BOTON QUE REALIZA LA OPERACION DE DIVIDIR
			public void actionPerformed(ActionEvent e) {
				acum = Mostrar.getText();
				a = (Double.parseDouble(acum));
				c = "/";
